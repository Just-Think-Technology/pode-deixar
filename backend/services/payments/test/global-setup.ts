// Test setup — provisions payments test database
...
const databaseUrl = process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/pode_deixar_test_payments?schema=public';
